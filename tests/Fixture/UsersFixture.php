...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'user_status_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => '1', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'role_id' => 1,
                'user_status_id' => 1,
                'name' => 'Teste Silva Sauro',
                'email' => 'teste@silva.sauro',
                'password' => '123456',
                'password_confirm' => '123456',
                'created' => '2020-06-17 14:23:26',
                'modified' => '2020-06-17 14:23:26',
            ],
        ];
        parent::init();
    }
