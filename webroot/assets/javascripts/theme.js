...
(function (theme, $) {
    ...
    var Skeleton = {
        ...
        fixScroll: function () {
            ...
            $window.on("sidebar-left-opened sidebar-right-toggle", function (
                e,
                data
            ) {
        ...
        buildSidebarLeft: function () {
            ...
            this.sidebars.left.isOpened =
                !$html.hasClass("sidebar-left-collapsed") ||
                $html.hasClass("sidebar-left-opened");
            ...
            if (typeof localStorage !== "undefined") {
                ...
                if (localStorage.getItem("sidebar-left-position") !== null) {
                    initialPosition = localStorage.getItem(
                        "sidebar-left-position"
                    );
        ...
        eventsSidebarLeft: function () {
            ...
            var close = function (e) {
                if (
                    !!e &&
                    !!e.target &&
                    ($(e.target).closest(".sidebar-left").get(0) ||
                        !$(e.target).closest("html").get(0))
                ) {
                    e.preventDefault();
                    return false;
                } else {
                    ...
                    _self.sidebars.left.isOpened = !$html.hasClass(
            ...
            var isToggler = function (element) {
                return (
                    $(element).data("fire-event") === "sidebar-left-toggle" ||
                    $(element).parents().data("fire-event") ===
                        "sidebar-left-toggle"
                );
            };
        ...
        buildSidebarRight: function () {
            this.sidebars.right.isOpened = $html.hasClass(
                "sidebar-right-opened"
            );

            if (this.customScroll) {
                this.sidebars.right.$nano = this.sidebars.right.$el.find(
                    ".nano"
                );
        ...
        eventsSidebarRight: function () {
            ...
            var close = function (e) {
                if (
                    !!e &&
                    !!e.target &&
                    ($(e.target).closest(".sidebar-right").get(0) ||
                        !$(e.target).closest("html").get(0))
                ) {
                    return false;
                }
        ...
        eventsContentMenu: function () {
            ...
            var close = function (e) {
                ...
                isCollapseButton =
                    hasTarget &&
                    !!$target.closest(".inner-menu-collapse").get(0);
                isInsideModal =
                    hasTarget && !!$target.closest(".mfp-wrap").get(0);
                isInsideInnerMenu =
                    hasTarget && !!$target.closest(".inner-menu").get(0);
                isInsideHTML = hasTarget && !!$target.closest("html").get(0);

                if (
                    (!isCollapseButton &&
                        (isInsideInnerMenu || !isInsideHTML)) ||
                    isInsideModal
                ) {
                    return false;
                }
...
(function (theme, $) {
    ...
    Mailbox.prototype = {
        ...
        setVars: function () {
            this.view = capitalizeString(
                this.$wrapper.data("mailbox-view") || ""
            );
        ...
        eventsCompose: function () {
            ...
            var adjustComposeSize = function () {
                ...
                contentBodyPaddingBottom =
                    parseInt($contentBody.css("paddingBottom"), 10) || 0;
            ...
            var timer;
            $(window).on(
                "resize orientationchange sidebar-left-toggle mailbox-recalc",
                function () {
                    clearTimeout(timer);
        ...
        $(".panel")
            .on("panel:toggle", function () {
                ...
                $this
                    ...
                    ["slide" + direction](200, function () {
                        $this[
                            (direction === "Up" ? "add" : "remove") + "Class"
                        ]("panel-collapsed");
                    });
            })
            .on("panel:dismiss", function () {
                ...
                if (
                    !!($this.parent("div").attr("class") || "").match(
                        /col-(xs|sm|md|lg)/g
                    ) &&
    ...
    $.extend(theme, {
        Nav: {
            ...
            build: function () {
                ...
                $header
                    .find(
                        ".dropdown-toggle:not(.notification-icon), .dropdown-submenu > a"
                    )
            ...
            events: function () {
                ...
                $header
                    .find(
                        '.dropdown-toggle[href="#"], .dropdown-submenu a[href="#"], .dropdown-toggle[href!="#"] .fa-caret-down, .dropdown-submenu a[href!="#"] .fa-caret-down'
                    )
                    .on("click", function (e) {
                        e.preventDefault();
                        if ($window.width() < 992) {
    ...
    PluginDatePicker.prototype = {
        ...
        build: function () {
            ...
            if (!!this.skin) {
                this.$el
                    .data("datepicker")
                    .picker.addClass("datepicker-" + this.skin);
            }
...
(function (theme, $) {
    ...
    PluginMultiSelect.defaults = {
        templates: {
            filter:
                '<div class="input-group"><span class="input-group-addon"><i class="fa fa-search"></i></span><input class="form-control multiselect-search" type="text"></div>',
        },
    };
    ...
    GMapBuilder.prototype = {
        ...
        build: function () {
                    ...
                    themeOpts.push(
                        $(
                            '<option value="' +
                                ...
                                theme.name +
                                "</option>"
                        ).data("json", theme.json)
                    );
                });

                this.$wrapper
                    .find('[data-builder-field="maptheme"]')
                    .append(themeOpts);
            }
            ...
            google.maps.event.addDomListener(window, "load", function () {
                _self.options.mapOptions.center = new google.maps.LatLng(
                    _self.options.mapOptions.center.lat,
                    _self.options.mapOptions.center.lng
                );

                _self.map = new google.maps.Map(
                    _self.$mapContainer.get(0),
                    _self.options.mapOptions
                );
        ...
        events: function () {
            ...
            this.$previewModal.on("hidden.bs.modal", function () {
                _self.$previewModal
                    .find("iframe")
                    .get(0).contentWindow.document.body.innerHTML = "";
            });
        ...
        updateMapProperty: {
            latlng: function () {
                ...
                lat = this.$wrapper
                    .find('[data-builder-field][name="latitude"]')
                    .val();
                lng = this.$wrapper
                    .find('[data-builder-field][name="longitude"]')
                    .val();
            ...
            maptype: function (value) {
                ...
                if (
                    $.inArray(google.maps.MapTypeId[value.toUpperCase()], [
                        "terrain",
                        "roadmap",
                    ]) > -1 &&
                    !!mapStyles
        ...
        updateControlValue: {
            latlng: function () {
                ...
                this.$wrapper
                    .find('[data-builder-field][name="latitude"]')
                    .val(roundNumber(center.lat(), 6));
                this.$wrapper
                    .find('[data-builder-field][name="longitude"]')
                    .val(roundNumber(center.lng(), 6));
            },
            ...
            zoomlevel: function () {
                ...
                $control = this.$wrapper.find(
                    '[data-builder-field="zoomlevel"]'
                );
        ...
        _geocode: function (marker) {
            ...
            this.geocoder.geocode({ address: marker.location }, function (
                response,
                status
            ) {
        ...
        _onGeocodeResult: function (marker, response, status) {
            ...
            if (!response || status !== google.maps.GeocoderStatus.OK) {
                ...
                marker.lat =
                    Math.round(result.geometry.location.lat() * 1000000) /
                    1000000;
                marker.lng =
                    Math.round(result.geometry.location.lng() * 1000000) /
                    1000000;
        ...
        _appendMarkerToList: function (marker) {
            ...
            html = html.replace(
                /\{location\}/,
                !!marker.title ? marker.title : marker.location
            );
        ...
        preview: function () {
            ...
            previewHtml = [
                ...
                "</style>",
                '<div id="' +
                    this.$wrapper.find('[data-builder-field="mapid"]').val() +
                    '" style="width: 100%; height: 100%;"></div>',
            ];

            iframe = this.$previewModal.find("iframe").get(0).contentWindow
                .document;
            ...
            googleScript.text =
                'function loadScript() { var script = document.createElement("script"); script.type = "text/javascript"; script.src = "//maps.googleapis.com/maps/api/js?key=&sensor=&callback=initialize"; document.body.appendChild(script); } loadScript()';
        ...
        getCode: function () {
            this.$getCodeModal
                .find(".modal-body pre")
                .html(
                    this.generate().replace(/</g, "&lt;").replace(/>/g, "&gt;")
                );
        },
        ...
        generate: function () {
            ...
            var zoomControl =
                this.$wrapper
                    .find('[data-builder-field="zoomcontrol"] option:selected')
                    .val() !== "false";
            var mapTypeControl =
                this.$wrapper
                    .find(
                        '[data-builder-field="maptypecontrol"] option:selected'
                    )
                    .val() !== "false";
            var overviewMapControl = this.$wrapper
                .find('[data-builder-field="overviewcontrol"] option:selected')
                .val()
                .toLowerCase();
            var $themeControl = this.$wrapper
                .find('[data-builder-field="maptheme"] option:selected')
                .filter(":selected");
            ...
            output = output
                ...
                .replace(
                    ...
                    this.$wrapper
                        .find(
                            '[data-builder-field="zoomlevel"] option:selected'
                        )
                        .val()
                )
                ...
                .replace(
                    ...
                    this.$wrapper
                        .find(
                            '[data-builder-field="clicktozoomcontrol"] option:selected'
                        )
                        .val() === "false"
                )
                ...
                .replace(
                    ...
                    this.$wrapper
                        .find(
                            '[data-builder-field="scalecontrol"] option:selected'
                        )
                        .val() !== "false"
                )
                .replace(
                    ...
                    this.$wrapper
                        .find(
                            '[data-builder-field="scrollwheelcontrol"] option:selected'
                        )
                        .val() !== "false"
                )
                .replace(
                    ...
                    this.$wrapper
                        .find(
                            '[data-builder-field="pancontrol"] option:selected'
                        )
                        .val() !== "false"
                )
                .replace(
                    ...
                    this.$wrapper
                        .find(
                            '[data-builder-field="streetviewcontrol"] option:selected'
                        )
                        .val() !== "false"
                )
                .replace(
                    ...
                    this.$wrapper
                        .find(
                            '[data-builder-field="draggablecontrol"] option:selected'
                        )
                        .val() !== "false"
                )
                .replace(
                ...
                .replace(
                    /\{mapTypeId\}/,
                    this.$wrapper
                        .find('[data-builder-field="maptype"] option:selected')
                        .val()
                        .toUpperCase()
                );
            ...
            if (zoomControl) {
                ...
                output = output.replace(
                    ...
                    "zoomControlOptions: {\r\n                style: google.maps.ZoomControlStyle." +
                        this.$wrapper
                            .find(
                                '[data-builder-field="zoomcontrol"] option:selected'
                            )
                            .val()
                            .toUpperCase() +
                        "\r\n            },"
            ...
            if ($themeControl.val() !== "false") {
                output = output.replace(
                    /\{styles\}/,
                    ",\r\n            styles: " +
                        $themeControl.data("json").replace(/\r\n/g, "")
                );
            } else {
...
(function (theme, $) {
    ...
    PluginPortlet.prototype = {
        ...
        saveState: function (panel) {
            ...
            var collapse = panel
                    .find(".panel-actions")
                    .children("a.fa-caret-up, a.fa-caret-down"),
            ...
            if (!!data) {
                $.each(data, function (panelId, state) {
                    ...
                    if (!panel.data("portlet-state-loaded")) {
                        if (state == "collapsed") {
                            panel
                                .find(".panel-actions a.fa-caret-down")
                                .trigger("click");
                        } else if (state == "removed") {
                            panel
                                .find(".panel-actions a.fa-times")
                                .trigger("click");
                        }
        ...
        events: function ($el) {
            ...
            $el.find(".panel-actions").on(
                "click",
                "a.fa-caret-up, a.fa-caret-down, a.fa-times",
                function (e) {
                    setTimeout(function () {
                        _self.saveState($el);
                    }, 250);
    ...
    WidgetToggleExpand.prototype = {
        ...
        events: function () {
            ...
            $toggler.on("click.widget-toggler", function () {
                _self.$el.hasClass("widget-collapsed")
                    ? _self.expand(_self.$el)
                    : _self.collapse(_self.$el);
            });
        ...
        expand: function (content) {
            content
                .children(".widget-content-expanded")
                .slideDown("fast", function () {
                    $(this).css("display", "");
...
(function ($) {
    ...
    if ($.isFunction($.fn["dataTable"])) {
        $.extend(true, $.fn.dataTable.defaults, {
            sDom:
                "<'row datatables-header form-inline'<'col-sm-12 col-md-6'l><'col-sm-12 col-md-6'f>r><'table-responsive't><'row datatables-footer'<'col-sm-12 col-md-6'i><'col-sm-12 col-md-6'p>>",
            oLanguage: {
            ...
            fnInitComplete: function (settings, json) {
                ...
                var options =
                    $("table", settings.nTableWrapper).data("plugin-options") ||
                    {};
                ...
                $search
                    .attr({
                        placeholder:
                            typeof options.searchPlaceholder !== "undefined"
