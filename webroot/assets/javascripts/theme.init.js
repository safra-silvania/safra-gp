...
(function ($) {
    ...
    $widgets.each(function () {
        ...
        $toggler.on("click.widget-toggler", function () {
            $widget.hasClass("widget-collapsed")
                ? expand($widget)
                : collapse($widget);
        });
    });
...
(function ($) {
    ...
    if ($.isFunction($.fn["appear"])) {
        $(function () {
            $("[data-plugin-animate], [data-appear-animation]").each(
                function () {
                    var $this = $(this),
                        opts = {};
...
(function ($) {
    ...
    if ($.isFunction($.fn["easyPieChart"])) {
        $(function () {
            $(
                "[data-plugin-chart-circular], .circular-bar-chart:not(.manual)"
            ).each(function () {
                var $this = $(this),
                    opts = {};
...
(function ($) {
    ...
    if ($.isFunction($.fn["magnificPopup"])) {
        $(function () {
            $("[data-plugin-lightbox], .lightbox:not(.manual)").each(
                function () {
                    var $this = $(this),
                        opts = {};
...
(function ($) {
    ...
    if ($.isFunction($.fn["themePluginWidgetToggleExpand"])) {
        $(function () {
            $("[data-plugin-toggle-expand], .widget-toggle-expand").each(
                function () {
                    var $this = $(this),
                        opts = {};
...
(function ($) {
    ...
    if ($.isFunction($.fn["themePluginWordRotate"])) {
        $(function () {
            $("[data-plugin-word-rotate], .word-rotate:not(.manual)").each(
                function () {
                    var $this = $(this),
                        opts = {};
