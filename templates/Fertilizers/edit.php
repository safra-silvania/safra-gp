...
<?= $this->Form->create($fertilizer, ['class' => 'form-horizontal form-bordered']) ?>
...
<div class="col-lg-12">
    <section class="panel">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                <label class="col-md-3 col-sm-4 col-xs-12 control-label required-label" for="formula"><?= __('Formula') ?></label>
                <?= $this->Form->control('formula', ['class' => 'form-control', 'label' => false]) ?>
            </div>
            <div class="form-group">
                <label class="col-md-3 col-sm-4 col-xs-12 control-label" for="increment"><?= __('Increment') ?></label>
                <?= $this->Form->control('increment', ['class' => 'form-control', 'label' => false]) ?>
            </div>
            <div class="form-group">
                <label class="col-md-3 col-sm-4 col-xs-12 control-label" for="fertilizer_measure_unit_id"><?= __('Fertilizer_measure_unit_id') ?></label>
                <?= $this->Form->control('fertilizer_measure_unit_id', ['options' => $fertilizerMeasureUnits, 'empty' => true, 'class' => 'form-control', 'label' => false]) ?>
            </div>
        </div>
