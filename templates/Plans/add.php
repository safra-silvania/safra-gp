...
<?= $this->Form->create($plan, ['class' => 'form-horizontal form-bordered']) ?>
    ...
    <section class="panel">
        ...
        <div class="panel-body">
            <div class="form-group">
                <label class="col-md-3 col-sm-4 col-xs-12 control-label required-label" for="immobile_id"><?= __('Immobile_id') ?></label>
                <?= $this->Form->control('immobile_id', ['options' => $immobiles, 'class' => 'form-control', 'label' => false]) ?>
            </div>
            <div class="form-group">
                <label class="col-md-3 col-sm-4 col-xs-12 control-label required-label" for="plan_status_id"><?= __('Plan_status_id') ?></label>
                <?= $this->Form->control('plan_status_id', ['options' => $planStatuses, 'class' => 'form-control', 'label' => false]) ?>
            </div>
        </div>
