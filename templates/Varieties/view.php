 ...
 * @var \App\Model\Entity\Variety $variety
 */
?>
            ...
            <table class="table table-hover">
                <tbody>
                    <tr>
                        ...
                        <td class="col-lg-9"><?= h($variety->name) ?></td>
                    </tr>
                    <tr>
                        <th class="col-lg-3"><?= __('Id') ?></th>
                        <td class="col-lg-9"><?= $this->Number->format($variety->id) ?></td>
                    </tr>
                    <tr>
                        <th class="col-lg-3"><?= __('Created') ?></th>
                        <td class="col-lg-9"><?= h($variety->created) ?></td>
                    </tr>
                    <tr>
                        <th class="col-lg-3"><?= __('Modified') ?></th>
                        <td class="col-lg-9"><?= h($variety->modified) ?></td>
                    </tr>
                </tbody>
            </table>
        </div>
    ...
    <section class="panel panel-collapsed">
        <header class="panel-heading">
            <div class="panel-actions">
                <a href="#" id="view-audit-log" class="panel-action panel-action-toggle" data-panel-toggle="" data-target-url="<?= Cake\Routing\Router::url(["controller"=>"AuditLogs","action"=>"get-timeline-data", $variety->id, 'varieties']); ?>"></a>
            </div>
