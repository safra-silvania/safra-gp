                ...
                <table class="table mb-none">
                    <thead>
                        <tr>
                            ...
                            <th><?= $this->Paginator->sort('sketch_id', __('Sketch_id')) ?></th>
                            <th><?= $this->Paginator->sort('name', __('Name')) ?></th>
                            <th><?= $this->Paginator->sort('hash', __('Hash')) ?></th>
                            <th><?= $this->Paginator->sort('path', __('Path')) ?></th>
                            <th><?= $this->Paginator->sort('type', __('Type')) ?></th>
                            <th><?= $this->Paginator->sort('extension', __('Extension')) ?></th>
                    ...
                    <tbody>
                        <?php foreach ($files as $file): ?>
                            <tr>
                                ...
                                <td><?= $this->Number->format($file->sketch_id) ?></td>
                                <td><?= h($file->name) ?></td>
                                <td><?= h($file->hash) ?></td>
                                <td><?= h($file->path) ?></td>
                                <td><?= h($file->type) ?></td>
                                ...
                                <td class="actions">
                                    <?php
                                    if ($userAuthenticated && $userAuthenticated->can('view', $file)) {
                                        echo $this->Html->link(
                                    ...
                                    if ($userAuthenticated && $userAuthenticated->can('update', $file)) {
                                        echo $this->Html->link(
                                    ...
                                    if ($userAuthenticated && $userAuthenticated->can('delete', $file)) {
