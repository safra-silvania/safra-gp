...
<?= $this->Form->create($file, ['class' => 'form-horizontal form-bordered']) ?>
    ...
    <section class="panel">
        ...
        <div class="panel-body">
            <div class="form-group">
                <label class="col-md-3 col-sm-4 col-xs-12 control-label" for="sketch_id"><?= __('Sketch_id') ?></label>
                <?= $this->Form->control('sketch_id', ['class' => 'form-control', 'label' => false]) ?>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label class="col-md-3 col-sm-4 col-xs-12 control-label required-label" for="hash"><?= __('Hash') ?></label>
                <?= $this->Form->control('hash', ['class' => 'form-control', 'label' => false]) ?>
            </div>
            <div class="form-group">
                <label class="col-md-3 col-sm-4 col-xs-12 control-label required-label" for="path"><?= __('Path') ?></label>
                <?= $this->Form->control('path', ['class' => 'form-control', 'label' => false]) ?>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label class="col-md-3 col-sm-4 col-xs-12 control-label required-label" for="extension"><?= __('Extension') ?></label>
                <?= $this->Form->control('extension', ['class' => 'form-control', 'label' => false]) ?>
            </div>
        </div>
