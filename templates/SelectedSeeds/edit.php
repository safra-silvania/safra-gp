...
<?= $this->Form->create($selectedSeed, ['class' => 'form-horizontal form-bordered']) ?>
    ...
    <section class="panel">
        ...
        <div class="panel-body">
            <div class="form-group">
                <label class="col-md-3 col-sm-4 col-xs-12 control-label required-label" for="seed_id"><?= __('Seed_id') ?></label>
                <?= $this->Form->control('seed_id', ['options' => $seeds, 'class' => 'form-control', 'label' => false]) ?>
            </div>
            <div class="form-group">
