            ...
            <table class="table table-hover">
                <tbody>
                    <tr>
                        ...
                        <td class="col-lg-9"><?= $this->Number->format($role->id) ?></td>
                    </tr>
                    <tr>
                        <th class="col-lg-3"><?= __('Name') ?></th>
                        <td class="col-lg-9"><?= h($role->name) ?></td>
                    </tr>
                    <tr>
                        <th class="col-lg-3"><?= __('Created') ?></th>
                        <td class="col-lg-9"><?= h($role->created) ?></td>
                    </tr>
                    <tr>
                        <th class="col-lg-3"><?= __('Modified') ?></th>
                        <td class="col-lg-9"><?= h($role->modified) ?></td>
                    </tr>
                </tbody>
            </table>
        </div>
    ...
    <section class="panel panel-collapsed">
        <header class="panel-heading">
            <div class="panel-actions">
                <a href="#" id="view-audit-log" class="panel-action panel-action-toggle" data-panel-toggle="" data-target-url="<?= Cake\Routing\Router::url(["controller"=>"AuditLogs","action"=>"get-timeline-data", $role->id, 'roles']); ?>"></a>
            </div>
