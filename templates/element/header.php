<header class="header">
    <div class="logo-container">
        <!-- <a href="<?= Cake\Routing\Router::url(["controller"=>"Dashboard", "action"=>"index"]); ?>">
            <h2 class="logo">Safra <small>consultoria</small></h2>
        </a> -->
        <?php
        echo $this->Html->image("/img/logo-planilha.png", [
            "alt" => "Safra", "width"=>"", "height"=>"52", "class"=> "logo",
    ...
    <div class="header-right">
        ...
        <ul class="notifications">
            ...
            <li>
                <!--
                <a href="#" class="dropdown-toggle notification-icon" data-toggle="dropdown" title="Notificações">
                    <i class="fa fa-bell"></i>
                    <span class="badge" id="total-new-notifications">
                    <?php echo $this->cell('Inbox');?>
                    </span>
                </a>
                -->
            ...
            <a href="#" data-toggle="dropdown">
                <figure class="profile-picture">
                    <img
                        ...
                        data-lock-picture="data:image/png;base64,"
                        />
                </figure>
                <div class="profile-info" data-lock-name="<?=$myself->name?>" data-lock-email="<?=$myself->email?>">
                    <span class="name"><?=$myself->name?></span>
                    <span class="role"><?=$myself->role->name?></span>
                </div>
                ...
                <ul class="list-unstyled">
                    ...
                    <li>
                        ...
                        echo $this->Html->link(
                            ...
                            ['escape' => false, 'title' => 'Meu Perfil', 'role'=>'menuitem', 'tabindex'=>'-1']
                        );
                        ?>
                    </li>
                    <li>
                        ...
                        echo $this->Html->link(
                            ...
                            ['escape' => false, 'title' => 'Alterar Senha', 'role'=>'menuitem', 'tabindex'=>'-1']
                        );
                        ?>
                    </li>
                    <li>
