                ...
                <table class="table mb-none">
                    <thead>
                        <tr>
                            ...
                            <th><?= $this->Paginator->sort('resale', __('Resale')) ?></th>
                            <th><?= $this->Paginator->sort('city_id', __('City_id')) ?></th>
                            <th><?= $this->Paginator->sort('representative', __('Representative')) ?></th>
                            <th><?= $this->Paginator->sort('representative_phone', __('Representative_phone')) ?></th>
                            <th><?= $this->Paginator->sort('resale_phone', __('Resale_phone')) ?></th>
                    ...
                    <tbody>
                        <?php foreach ($suppliers as $supplier): ?>
                            <tr>
                                ...
                                <td><?= h($supplier->resale) ?></td>
                                <td><?= $supplier->has('city') ? ($userAuthenticated->can('view', $supplier->city) ? $this->Html->link($supplier->city->name, ['controller' => 'Cities', 'action' => 'view', $supplier->city->id]) : $supplier->city->name) : '' ?></td>
                                <td><?= h($supplier->representative) ?></td>
                                <td><?= h($supplier->representative_phone) ?></td>
                                <td><?= h($supplier->resale_phone) ?></td>
                                <td><?= h($supplier->created) ?></td>
                                <td><?= h($supplier->modified) ?></td>
                                <td class="actions">
                                    <?php
                                    if ($userAuthenticated && $userAuthenticated->can('view', $supplier)) {
                                        echo $this->Html->link(
                                    ...
                                    if ($userAuthenticated && $userAuthenticated->can('update', $supplier)) {
                                        echo $this->Html->link(
                                    ...
                                    if ($userAuthenticated && $userAuthenticated->can('delete', $supplier)) {
