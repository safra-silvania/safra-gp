 ...
 * @var \App\Model\Entity\SeedNote $seedNote
 */
?>
            ...
            <table class="table table-hover">
                <tbody>
                    <tr>
                        ...
                        <td class="col-lg-9"><?= h($seedNote->name) ?></td>
                    </tr>
                    <tr>
                        <th class="col-lg-3"><?= __('Class') ?></th>
                        <td class="col-lg-9"><?= h($seedNote->class) ?></td>
                    </tr>
                    <tr>
                        <th class="col-lg-3"><?= __('Id') ?></th>
                        <td class="col-lg-9"><?= $this->Number->format($seedNote->id) ?></td>
                    </tr>
                </tbody>
            </table>
        </div>
    ...
    <section class="panel panel-collapsed">
        <header class="panel-heading">
            <div class="panel-actions">
                <a href="#" id="view-audit-log" class="panel-action panel-action-toggle" data-panel-toggle="" data-target-url="<?= Cake\Routing\Router::url(["controller"=>"AuditLogs","action"=>"get-timeline-data", $seedNote->id, 'seedNotes']); ?>"></a>
            </div>
