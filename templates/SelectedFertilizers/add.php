...
<?= $this->Form->create($selectedFertilizer, ['class' => 'form-horizontal form-bordered']) ?>
    ...
    <section class="panel">
        ...
        <div class="panel-body">
            <div class="form-group">
                <label class="col-md-3 col-sm-4 col-xs-12 control-label required-label" for="fertilizer_id"><?= __('Fertilizer_id') ?></label>
                <?= $this->Form->control('fertilizer_id', ['options' => $fertilizers, 'class' => 'form-control', 'label' => false]) ?>
            </div>
            <div class="form-group">
