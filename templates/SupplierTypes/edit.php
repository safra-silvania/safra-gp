...
<?= $this->Form->create($supplierType, ['class' => 'form-horizontal form-bordered']) ?>
...
<div class="col-lg-12">
    <section class="panel">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                <label class="col-md-3 col-sm-4 col-xs-12 control-label" for="suppliers"><?= __('Suppliers') ?></label>
                <?= $this->Form->control('suppliers._ids', ['options' => $suppliers, 'class' => 'form-control', 'label' => false]) ?>
            </div>
        </div>
