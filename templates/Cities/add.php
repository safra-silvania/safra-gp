...
<?= $this->Form->create($city, ['class' => 'form-horizontal form-bordered']) ?>
    ...
    <section class="panel">
        ...
        <div class="panel-body">
            <div class="form-group">
                <label class="col-md-3 col-sm-4 col-xs-12 control-label required-label" for="state_id"><?= __('State_id') ?></label>
                <?= $this->Form->control('state_id', ['options' => $states, 'class' => 'form-control', 'label' => false]) ?>
            </div>
            <div class="form-group">
