    ...
    <section class="panel">
        ...
        <div class="panel-body">
          <div class="table-responsive">
            <table class="table table-bordered table-striped" id="selected-chemicals" data-url="<?= Cake\Routing\Router::url(["controller"=>"plans", "action" => "get-selected-chemicals", $plan->id]); ?>">
              <thead>
                <tr>
                  <th>&nbsp;</th>
                  <th>Cód</th>
...
<?= $this->Html->script("/bundle/selected_chemicals_index.bundle.js") ?>
