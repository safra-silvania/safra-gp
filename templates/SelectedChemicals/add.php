...
<?= $this->Form->create($selectedChemical, ['class' => 'form-horizontal form-bordered']) ?>
    ...
    <section class="panel">
        ...
        <div class="panel-body">
            <div class="form-group">
                <label class="col-md-3 col-sm-4 col-xs-12 control-label required-label" for="chemical_id"><?= __('Chemical_id') ?></label>
                <?= $this->Form->control('chemical_id', ['options' => $chemicals, 'class' => 'form-control', 'label' => false]) ?>
            </div>
            <div class="form-group">
