 ...
 * @var \App\Model\Entity\ChemicalMeasureUnit[]|\Cake\Collection\CollectionInterface $chemicalMeasureUnits
 */
?>
        ...
        <div class="panel-body">
            <div class="table-responsive">
                <table class="table mb-none">
                    ...
                    <tbody>
                        <?php foreach ($chemicalMeasureUnits as $chemicalMeasureUnit): ?>
                            <tr>
                                <td><?= $this->Number->format($chemicalMeasureUnit->id) ?></td>
                                <td><?= h($chemicalMeasureUnit->name) ?></td>
                                <td><?= h($chemicalMeasureUnit->initial) ?></td>
                                <td><?= h($chemicalMeasureUnit->created) ?></td>
                                <td><?= h($chemicalMeasureUnit->modified) ?></td>
                                <td class="actions">
                                    <?php
                                    if ($userAuthenticated && $userAuthenticated->can('view', $chemicalMeasureUnit)) {
                                        echo $this->Html->link(
                                            '<button type="button" class="mr-xs mb-xs btn btn-xs btn-info"><i class="fa fa-search"></i></button>',
                                            ['action' => 'view', $chemicalMeasureUnit->id],
                                            ['escape' => false, 'title' => 'Visualizar']
                                        );
                                    }

                                    if ($userAuthenticated && $userAuthenticated->can('update', $chemicalMeasureUnit)) {
                                        echo $this->Html->link(
                                            '<button type="button" class="mr-xs mb-xs btn btn-xs btn-warning"><i class="fa fa-pencil"></i></button>',
                                            ['action' => 'edit', $chemicalMeasureUnit->id],
                                            ['escape' => false, 'title' => 'Editar']
                                        );
                                    }
                                        
                                    if ($userAuthenticated && $userAuthenticated->can('delete', $chemicalMeasureUnit)) {
                                        echo $this->Form->postLink(
                                            '<button type="button" class="mr-xs mb-xs btn btn-xs btn-danger"><i class="fa fa-trash-o"></i></button>',
                                            ['action' => 'delete', $chemicalMeasureUnit->id],
