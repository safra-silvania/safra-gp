...
<?= $this->Form->create($chemicalActionMode, ['class' => 'form-horizontal form-bordered']) ?>
...
<div class="col-lg-12">
    <section class="panel">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                <label class="col-md-3 col-sm-4 col-xs-12 control-label" for="chemicals"><?= __('Chemicals') ?></label>
                <?= $this->Form->control('chemicals._ids', ['options' => $chemicals, 'class' => 'form-control', 'label' => false]) ?>
            </div>
        </div>
