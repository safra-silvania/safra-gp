        ...
        if ($this->request->is('post')) {
            ...
            if ($email) {
                try {
                    ...
                    $mailer
                        ->setFrom(['contato@safragp.com.br' => 'Safra GP'])
                        ->setTo($email)
                        ->setSubject('About')
                        ->deliver("{$email} - Teste é um teste");
                ...
                \Cake\Log\Log::write('debug', $emailReturn);

                $this->Flash->success("Sua mensagem foi enviada com sucesso");
                $this->redirect(['controller' => 'pages', 'action' => 'test-email']);
            } else {
